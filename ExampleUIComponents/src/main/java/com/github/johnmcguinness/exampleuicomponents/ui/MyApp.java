 ...
 * parameter <code>bordertech.wcomponents.lde.component.to.launch=com.github.johnmcguinness.exampleuicomponents</code>
...
public class MyApp extends WApplication implements MessageContainer
{
    ...
    public MyApp()
    {
		...
		messages.setMargin(new Margin(Size.LARGE));
    	// Main screens
		...
		footerPanel.setMargin(new Margin(Size.LARGE));
