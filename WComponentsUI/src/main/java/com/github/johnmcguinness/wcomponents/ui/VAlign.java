...
public enum VAlign {
	...
	public FlowLayout.ContentAlignment toFlowLayoutContentAlignment() {
		switch (this) {
			case TOP:
				return FlowLayout.ContentAlignment.TOP;
			case MIDDLE:
				return FlowLayout.ContentAlignment.MIDDLE;
			case BASELINE:
				return FlowLayout.ContentAlignment.BASELINE;
			case BOTTOM:
				return FlowLayout.ContentAlignment.BOTTOM;
			default:
				return FlowLayout.ContentAlignment.MIDDLE;
		}
	}
